            ...
            <div class="flex items-center gap-3">
                ...
                @auth
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-gray-200 transition hover:bg-white/20 hover:text-white" aria-label="{{ __('Log out') }}" title="{{ __('Log out') }}">
