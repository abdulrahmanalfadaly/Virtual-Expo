<x-admin-layout title="Gallery — {{ $school->name }}">
    <div class="mb-6">
    ...
    <div class="mb-6 rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
        ...
        <form method="POST" action="{{ route('admin.schools.gallery.store', $school) }}" enctype="multipart/form-data" class="mt-4 flex flex-wrap items-end gap-4">
            @csrf
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
        @forelse ($images as $image)
            <div class="group relative aspect-square overflow-hidden rounded-xl bg-gray-100">
                ...
                <form method="POST" action="{{ route('admin.schools.gallery.destroy', [$school, $image]) }}" onsubmit="return confirm('Remove this image?')"
