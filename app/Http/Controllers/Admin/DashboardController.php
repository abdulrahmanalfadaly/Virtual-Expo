...
class DashboardController extends Controller
{
    public function index(): View
    {
        ...
        return view('admin.dashboard', [
            ...
            'settings' => SiteSetting::getMany(['site_name', 'site_name_ar', 'allow_registration', 'allow_applications', 'require_admin_approval', 'link_preview_image_path', 'expo_logo_path', 'show_site_name_in_nav', 'nav_logo_height', 'dev_mode_enabled', 'dev_mode_message', 'dev_mode_ends_at']),
